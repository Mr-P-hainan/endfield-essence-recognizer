...
## Purpose
Detect recognition failure patterns early and abort scanning with clear feedback to improve user experience and avoid wasting time on non-functional scans.
